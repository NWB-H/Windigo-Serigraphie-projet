...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez ici définir des messages de validation personnalisés pour
    | des attributs en utilisant la convention "attribut.regle".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes permettent de remplacer le placeholder :attribute
    | par un libellé plus lisible, comme "Adresse e-mail" au lieu de
    | "email".
    |
    */
