...
<head>
    <meta charset="UTF-8">
    <title>Résumé de commande #{{ $order->id }}</title>
</head>
    ...
    <div style="max-width:640px;margin:0 auto;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 10px 15px -3px rgba(0,0,0,0.1),0 4px 6px -4px rgba(0,0,0,0.1);">
        ...
        <div style="padding:40px 32px;">
            ...
            <p style="margin:0 0 32px;font-size:16px;line-height:24px;color:#475569;text-align:center;">
                Voici le résumé de la commande à préparer et à envoyer.
            </p>
            ...
            <div style="margin-bottom:32px;padding:24px;background-color:#f8fafc;border-radius:12px;border:1px solid #e2e8f0;">
                ...
                <p style="margin:0 0 8px;font-size:14px;line-height:20px;color:#334155;">
                    <strong>Nom / Prénom :</strong> {{ $order->user->name }}
                </p>
            ...
            <div style="margin-bottom:32px;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                    <thead>
                    <tr>
                        <th align="left" style="padding:12px;border-bottom:1px solid #e2e8f0;font-size:13px;color:#64748b;">Produit</th>
                        <th align="center" style="padding:12px;border-bottom:1px solid #e2e8f0;font-size:13px;color:#64748b;">Qté</th>
                        <th align="right" style="padding:12px;border-bottom:1px solid #e2e8f0;font-size:13px;color:#64748b;">Prix</th>
                        <th align="right" style="padding:12px;border-bottom:1px solid #e2e8f0;font-size:13px;color:#64748b;">Total</th>
                    </tr>
                    </thead>
                    ...
                    @foreach($order->products as $product)
                        <tr>
                            <td style="padding:12px;border-bottom:1px solid #e2e8f0;font-size:14px;color:#334155;">
                                <a
                                    href="{{ route('productItem', $product->id) }}"
                                    style="color:#a88871;text-decoration:none;font-weight:600;"
                                >
                                    {{ $product->name }}
                                </a>
                            </td>
                            ...
                            <td align="right" style="padding:12px;border-bottom:1px solid #e2e8f0;font-size:14px;font-weight:700;color:#0f172a;">
