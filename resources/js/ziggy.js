const Ziggy = {
    ...
    routes: {
        ...
        'forgot-password.store': { uri: 'forgot-password', methods: ['POST'] },
        'password.reset': { uri: 'reset-password', methods: ['GET', 'HEAD'] },
        'password.reset.store': { uri: 'reset-password', methods: ['POST'] },
        'contact.form.store': { uri: 'contact-form', methods: ['POST'] },
        'api.webhook.stripe': {
        ...
        'api.workshops.delete': {
            uri: 'api\/workshops\/{workshop}',
            methods: ['DELETE'],
            parameters: ['workshop'],
            bindings: { workshop: 'id' },
        },
        'api.workshops.deleteMedia': {
            uri: 'api\/workshops\/{workshop}\/medias\/{media}',
            methods: ['DELETE'],
            parameters: ['workshop', 'media'],
            bindings: { workshop: 'id', media: 'id' },
        },
        'api.workshops.highlightImage': {
            uri: 'api\/workshops\/{workshop}\/medias\/{media}\/highlighted',
            methods: ['PATCH'],
            parameters: ['workshop', 'media'],
            bindings: { workshop: 'id', media: 'id' },
        },
        'api.cities.search': {
            uri: 'api\/cities\/search\/{postalCode}',
            methods: ['GET', 'HEAD'],
