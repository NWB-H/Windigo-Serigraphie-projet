  ...
  if (workshop.value) {
    useHead({
      ...
      meta: [
        ...
        { property: 'og:image', content: workshop.value.images?.length ? `http://windigoprint-backend.fohu7030.odns.fr/storage/${workshop.value.images[0]}` : '' },
      ...
      <div class="col-md-6">
        ...
        <div v-if="workshop.images?.length" id="workshopCarousel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div v-for="(img, index) in workshop.images" :key="index"
              ...
              <img :src="`http://windigoprint-backend.fohu7030.odns.fr/storage/${img}`" class="d-block w-100 rounded" />
            </div>
          </div>
        ...
        <div v-if="workshop.images?.length > 1" ref="thumbnailsContainer"
          ...
          <img v-for="(img, index) in workshop.images" :key="'thumb-' + index"
            :src="`http://windigoprint-backend.fohu7030.odns.fr/storage/${img}`" class="thumbnail"
